<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.Master" AutoEventWireup="true"
    CodeBehind="HammerReplacement.aspx.cs" Inherits="Source.Expenses.HammerReplacement" %>

<asp:Content ID="HammerReplacementHeadContent" runat="server" ContentPlaceHolderID="ContentPlaceHolderHead">
...
<asp:Content ID="HammerReplacementBodyContent" runat="server" ContentPlaceHolderID="ContentPlaceHolderMain">
    <asp:UpdatePanel ID="updpnlMainContentBitExpenses" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:UpdateProgress ID="UpdateProgress_updpnlMainContentBitExpenses" runat="server"
                DisplayAfter="0" AssociatedUpdatePanelID="updpnlMainContentBitExpenses">
                <ProgressTemplate>
                    <div class="ProgressPageOverlay">
                        <asp:Image ID="imgloaderupdpnlMainContentBitExpenses" CssClass="ProgressImage" runat="server"
            ...
            <div class="centermaincontaineryle">
                ...
                <div class="BitReplacementcentercontainer">
                    ...
                    <div class="divExpensessinglecontainer">
                        <div class="divExpensesleftcontainer">
                            Hammer Expenses ID</div>
                        <div class="divExpensesrightcontainer">
                            <asp:DropDownList runat="server" ID="ddlBitExpenses" CssClass="ddlvehicleMaster"
                                AutoPostBack="true" OnSelectedIndexChanged="ddlBitExpenses_SelectedIndexChanged">
                            </asp:DropDownList>
                    ...
                    <div class="divExpensessinglecontainer">
                        ...
                        <div class="bitReplacementtextboxcontainer">
                            ...
                            <asp:TextBox ID="txtFirstTotal" runat="server" Width="60px"></asp:TextBox>
                                ...
                                SetFocusOnError="true" Display="Dynamic" Type="Double" Operator="DataTypeCheck"
                                ErrorMessage="*" ToolTip="Please enter a valid numbers."></asp:CompareValidator>
                            <asp:TextBox ID="txtFirstReplacement" runat="server" Width="60px" OnTextChanged="txtFirstReplacement_TextChanged"
                    ...
                    <div class="divExpensessinglecontainer">
                        ...
                        <div class="bitReplacementtextboxcontainer">
                            ...
                            <asp:CompareValidator ID="Compare_txtSecTotal" runat="server" ControlToValidate="txtSecTotal"
                                SetFocusOnError="true" Display="Dynamic" Type="Double" Operator="DataTypeCheck"
                                ErrorMessage="*" ToolTip="Please enter a valid numbers."></asp:CompareValidator>
                            <asp:TextBox ID="txtSecReplacement" runat="server" Width="60px" OnTextChanged="txtSecReplacement_TextChanged"
                                AutoPostBack="true"></asp:TextBox></div>
                    </div>
                    <div class="divExpensessinglecontainer">
                        <div class="divExpensesleftcontainer">
                        ...
                        <div class="bitReplacementtextboxcontainer">
                            ...
                            <asp:TextBox ID="txtThirdTotal" runat="server" Width="60px"></asp:TextBox>
                             <asp:CompareValidator ID="Compare_txtThirdTotal" runat="server" ControlToValidate="txtThirdTotal"
                                SetFocusOnError="true" Display="Dynamic" Type="Double" Operator="DataTypeCheck"
                                ErrorMessage="*" ToolTip="Please enter a valid numbers."></asp:CompareValidator>
                            <asp:TextBox ID="txtThirdRepalcement" runat="server" Width="60px" OnTextChanged="txtThirdRepalcement_TextChanged"
                                AutoPostBack="true"></asp:TextBox></div>
                    </div>
                    <div class="divExpensessinglecontainer">
                        <div class="divExpensesleftcontainer">
                    ...
                    <div class="bitVendorDetailSinglewhole" style="margin-bottom: 10px; display: none;">
                        ...
                        <div class="bitVendorDetailSingle" style="height: 70px; width: 450px;">
                            ...
                            <div class="bitVendorRightContainer" style="width: 300px;">
                                <asp:TextBox ID="txtDetails" runat="server" Width="280px" Height="60px" TextMode="MultiLine"></asp:TextBox></div>
                        </div>
                    </div>
