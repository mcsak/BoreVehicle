...
{
    public partial class HammerReplacement : System.Web.UI.Page
    {
        ...
        public void getBitexpenseID(int VendorID)
        {
            ...
            ds = new DataSet();
            ds = ExpenseDAL.GetHammerExpensesIDForDDL(VendorID);
            if (ds != null)
                if (ds.Tables.Count > 0)
                    if (ds.Tables[0].Rows.Count > 0)
                    {
        ...
        public void GetBitReplacement(Int64 HammerID)
        {
            CasingD dCasing = new CasingD();
            ds = new DataSet();
            ds = dCasing.GetHammerReplacement(HammerID);
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        txtFirstQty.Text = ds.Tables[0].Rows[0]["HammerQty"].ToString();
                        txtSecondQty.Text = ds.Tables[0].Rows[1]["HammerQty"].ToString();
                        txtThirdQty.Text = ds.Tables[0].Rows[2]["HammerQty"].ToString();  
                        ...
                        txtGrandtotal.Text = ds.Tables[0].Rows[0]["GrandTotalRate"].ToString();
                        txtTotalAmount.Text = ds.Tables[0].Rows[0]["GrandTotalRate"].ToString();
                    }
