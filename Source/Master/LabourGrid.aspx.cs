...
{
    public partial class LabourGrid : System.Web.UI.Page
    {
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ViewState["SortColIndex"].ToString() != "")
                        {
                            ...
                            gvLabour.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"].ToString())].Controls.Add(imgSort);
                        }
                    }
                    else
                    {
                        Response.Redirect("~/Master/Labour.aspxOID=0&op=1");
                        gvLabour.Visible = false;
        ...
        protected void gvLabour_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (ViewState["SortColIndex"].ToString() != "")
            {
                ...
                gvLabour.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"])].Controls.Add(imgSort);
            }
        }
        protected void gvLabour_SelectedIndexChanged(object sender, GridViewPageEventArgs e)
        {
        ...
        {
            Response.Redirect("~/Master/Labour.aspx?OID=0&op=1");
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Master/Labour.aspx?OID=" + OID + "&op=2");
        }

        protected void btnDelete_Click(object sender, EventArgs e)
        {
            long OID = Convert.ToInt64(Request.Form["optionID"]);
            Response.Redirect("~/Master/Labour.aspx?OID=" + OID + "&op=3");
