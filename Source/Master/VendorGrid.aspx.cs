...
{
    public partial class VendorGrid : System.Web.UI.Page
    {
        ...
        public void bindGrid(string Searchtxt = "", byte flag = 0)
        {
            ...
            if (Searchtxt == "" && flag == 0)
            {
                ds = Ma_D.GetVendors( Searchtxt, flag);
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ViewState["SortColIndex"].ToString() != "")
                        {
                            ...
                            gvVendor.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"].ToString())].Controls.Add(imgSort);
                        }
                    }
                    else
                    {
                        Response.Redirect("~/Master/Vendor.aspxOID=0&op=1");
        ...
        protected void gvVendor_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (ViewState["SortColIndex"].ToString() != "")
            {
                ...
                gvVendor.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"])].Controls.Add(imgSort);
            }
        }
        protected void gvVendor_SelectedIndexChanged(object sender, GridViewPageEventArgs e)
        {
        ...
        {
            Response.Redirect("~/Master/Vendor.aspx?OID=0&op=1");
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Master/Vendor.aspx?OID=" + OID + "&op=2");
        }

        protected void btnDelete_Click(object sender, EventArgs e)
        {
            long OID = Convert.ToInt64(Request.Form["optionID"]);
            Response.Redirect("~/Master/Vendor.aspx?OID=" + OID + "&op=3");
