<%@ Page Title="Profile" Language="C#" MasterPageFile="~/InnerMaster.Master" AutoEventWireup="true" CodeBehind="ProfileGrid.aspx.cs" Inherits="Source.General.ProfileGrid" %>
    ...
    <div class="admingriCenterContainer">
                ...
                <div class="adminpagegridcontainer">
                    ...
                    <div class="admingridcontainer">
                        <asp:GridView ID="gvProfile" runat="server" Width="100%" PagerStyle-Height="30px" OnSelectedIndexChanging="gvProfile_SelectedIndexChanged" OnSorting="gvProfile_Sorting"  >
                            <Columns>
