...
{
    public partial class ProfileGrid : System.Web.UI.Page
    {
                ...
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ViewState["SortColIndex"].ToString() != "")
                        {
                            ...
                            gvProfile.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"].ToString())].Controls.Add(imgSort);
                        }
                    }
                    else
                    {
                        Response.Redirect("~/General/Profile.aspxOID=0&op=1");
        ...
        protected void gvProfile_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (ViewState["SortColIndex"].ToString() != "")
            {
                ...
                gvProfile.HeaderRow.Cells[Convert.ToInt16(ViewState["SortColIndex"])].Controls.Add(imgSort);
            }
        }
        protected void gvProfile_SelectedIndexChanged(object sender, GridViewPageEventArgs e)
        {
        ...
        {
            Response.Redirect("~/General/Profile.aspx?OID=0&op=1");
        ...
        protected void btnModify_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/General/Profile.aspx?OID=" + OID + "&op=2");
        }

        protected void btnDelete_Click(object sender, EventArgs e)
        {
            long OID = Convert.ToInt64(Request.Form["optionID"]);
            Response.Redirect("~/General/Profile.aspx?OID=" + OID + "&op=3");
