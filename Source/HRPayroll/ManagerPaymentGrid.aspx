<%@ Page Title="Manager Payment" Language="C#" MasterPageFile="~/InnerMaster.Master" AutoEventWireup="true" CodeBehind="ManagerPaymentGrid.aspx.cs" Inherits="Source.HRPayroll.ManagerPaymentGrid" %>
    ...
    <div class="admingriCenterContainer">
                ...
                <div class="adminpagegridcontainer">
                    ...
                    <div class="admingridcontainer">
                        <asp:GridView ID="gvMDPayment" runat="server" Width="100%" PagerStyle-Height="30px"  OnSelectedIndexChanging="gvMDPayment_SelectedIndexChanged" OnSorting="gvMDPayment_Sorting"  >
                            <Columns>
