<%@ Page Title="Labour Paymnet" Language="C#" MasterPageFile="~/InnerMaster.Master" AutoEventWireup="true" CodeBehind="LabourPaymentGrid.aspx.cs" Inherits="Source.HRPayroll.LabourPaymentGrid" %>
...
<script type="text/javascript">
    ...
    function gridsearchvalidation() {
        if ((document.getElementById("ctl00_ContentPlaceHolderMain_txtsearch").value == "") || (document.getElementById("ctl00_ContentPlaceHolderMain_txtsearch").value == "")) {
            $('div[id$=warningmsg]').css({ 'visibility': 'visible', 'display': 'block' });
    ...
    <div class="admingriCenterContainer">
                ...
                <div class="adminpagegridcontainer">
                    ...
                    <div class="admingridcontainer">
                        <asp:GridView ID="gvLabourPayment" runat="server" Width="100%" PagerStyle-Height="30px"  OnSelectedIndexChanging="gvLabourPayment_SelectedIndexChanged" OnSorting="gvLabourPayment_Sorting"  >
                            <Columns>
